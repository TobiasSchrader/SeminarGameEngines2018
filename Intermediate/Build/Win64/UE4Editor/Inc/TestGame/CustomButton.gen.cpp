...
// Cross Module References
	TESTGAME_API UClass* Z_Construct_UClass_UCustomButton_NoRegister();
	TESTGAME_API UClass* Z_Construct_UClass_UCustomButton();
...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UCustomButton()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
				{ "IncludePath", "CustomButton.h" },
				{ "ModuleRelativePath", "CustomButton.h" },
			};
#endif
	...
	IMPLEMENT_CLASS(UCustomButton, 1871044060);
	static FCompiledInDefer Z_CompiledInDefer_UClass_UCustomButton(Z_Construct_UClass_UCustomButton, &UCustomButton::StaticClass, TEXT("/Script/TestGame"), TEXT("UCustomButton"), false, nullptr, nullptr, nullptr);
